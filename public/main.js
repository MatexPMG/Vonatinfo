  ...
  fetch('https://vonatinfo-production.up.railway.app/api/trains')
    ...
    .then(json => {
      ...
      if (Array.isArray(json) && json.length === 0) {
        alert("Nincs megjeleníthető vonat.\n\nLehet, hogy a szerver nem adott vissza adatot.");
        return; // Stop processing
      }
      // ----------------------------

      // Your existing marker code continues here...
      console.log("Train count:", json.length);
